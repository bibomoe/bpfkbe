...
export const login = (req, res) => {
    ...
    users.findAll({
        attributes: ['id','nama','email','password', 'data_satker_id','created_at', 'modified_at'],
        where: {
    ...
    .then((results) => {
        ...
        bcrypt.compare(req.body.password, results[0].password, (error, compareResult) => {
            ...
            const payloadObject = {
                ...
                dataSatkerId: results[0].data_satker_id
            }
